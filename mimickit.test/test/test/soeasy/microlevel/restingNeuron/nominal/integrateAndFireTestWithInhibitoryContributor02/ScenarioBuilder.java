...
public class ScenarioBuilder extends SOEasyScenarioBuilder {
	...
	protected void createAgents() {
		...
		getAgentFactory().createSynapse(null, preNeuronExc, restingNeuron, 13.0);
		// synapse9
		getAgentFactory().createSynapse(null, preNeuronInh, restingNeuron, 14.0);
		// synapse10
		getAgentFactory().createSynapse(null, preNeuronInh, restingNeuron, 15.0);
		// synapse11
		getAgentFactory().createSynapse(null, preNeuronInh, restingNeuron, 16.0);
		// synapse12
		getAgentFactory().createSynapse(null, preNeuronInh, restingNeuron, 17.0);		
	}
}
