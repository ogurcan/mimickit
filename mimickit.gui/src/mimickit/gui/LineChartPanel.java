 ...
 * 
 */
public class LineChartPanel extends org.jfree.chart.ChartPanel {
	...
	public LineChartPanel(JFrame parent, String title, String xAxisLabel,
			String yAxisLabel, boolean legend) {
		super(ChartFactory.createXYLineChart(title, xAxisLabel, yAxisLabel,
